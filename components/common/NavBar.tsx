...
const NavBar = () => {
  ...
  const handleTabClick = (sectionId: string) => {
    ...
    // which can also scroll the document/body (see Sidebar.tsx for why).
  ...
  return (
    <div className='flex flex-col px-3 py-2 w-full'>
            ...
            {TABS.map((tab) => {
              ...
              return (
                <li
                  ...
                  className={`flex items-center cursor-pointer gap-2 px-1 rounded transition-colors duration-150 ${
        ...
        <div className='text-white z-50 w-full bg-[#121314]'>
          app {'>'} page.tsx
        </div>
    </div>
  )
