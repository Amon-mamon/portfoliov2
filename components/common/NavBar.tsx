...
const NavBar = () => {
  ...
  return (
    <div className='flex flex-col w-full bg-[#181818] border-b border-[#2b2b2b] select-none text-xs font-mono'>
      ...
      {/* ── Top Tabs Row ───────────────────────────────── */}
      <nav className="overflow-x-auto scrollbar-none bg-[#252526]">
      ...
      {/* ── Breadcrumb Bar ─────────────────────────────── */}
      <div className='flex items-center gap-1.5 px-4 py-1 bg-[#1e1e1e] text-[#858585] border-t border-[#252526] text-[11px]'>
        <span>app</span>
        ...
        {activeTab && (
          <>
            <ChevronRight size={12} className="text-gray-600" />
            <span className="text-[#e2c08d] flex items-center gap-1">
              {activeTab.label}
            </span>
          </>
        )}
